...
class CyclexWalletController(http.Controller):
    ...
    @http.route('/api/cyclex/wallet/balance', type='json', auth='user', methods=['GET'], csrf=False)
    ...
    @http.route('/api/cyclex/wallet/transactions', type='json', auth='user', methods=['GET'], csrf=False)
    ...
    @http.route('/api/cyclex/wallet/withdraw', type='json', auth='user', methods=['POST'], csrf=False)
